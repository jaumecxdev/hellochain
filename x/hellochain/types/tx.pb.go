...
func (*MsgUpdateParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_4c349c7dbc635604, []int{0}
}
...
func (*MsgUpdateParamsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_4c349c7dbc635604, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgUpdateParams)(nil), "hellochain.hellochain.MsgUpdateParams")
	proto.RegisterType((*MsgUpdateParamsResponse)(nil), "hellochain.hellochain.MsgUpdateParamsResponse")
}

func init() { proto.RegisterFile("hellochain/hellochain/tx.proto", fileDescriptor_4c349c7dbc635604) }

var fileDescriptor_4c349c7dbc635604 = []byte{
	// 320 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x92, 0xcb, 0x48, 0xcd, 0xc9,
	0xc9, 0x4f, 0xce, 0x48, 0xcc, 0xcc, 0xd3, 0x47, 0x62, 0x96, 0x54, 0xe8, 0x15, 0x14, 0xe5, 0x97,
	...
	0x35, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0x0c, 0x58, 0xa6, 0x25, 0x54, 0x02, 0x00, 0x00,
}
...
func (c *msgClient) UpdateParams(ctx context.Context, in *MsgUpdateParams, opts ...grpc.CallOption) (*MsgUpdateParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/hellochain.hellochain.Msg/UpdateParams", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_UpdateParams_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hellochain.hellochain.Msg/UpdateParams",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "hellochain.hellochain.Msg",
	...
	Metadata: "hellochain/hellochain/tx.proto",
}
